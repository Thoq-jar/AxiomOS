...
<div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        <div
            ...
            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Axiom has a lot of features. <br>We suggest you start
            ...
            <h6 class="text-[#706f6c] dark:text-[#A1A09A] opacity-50">
                Accounts are for permission management,<br/>
                no data will leave your server
            </h6>
        </div>
        <div
            ...
            <h1 style="font-size: min(9rem, 23vw); font-family: 'Helvetica Neue', Arial, sans-serif;"
                class="ttext-[#f53003] dark:text-[#FF4433] text-center">AXIOM</h1>
            <h1 style="font-size: min(9rem, 23vw); font-family: 'Helvetica Neue', Arial, sans-serif;"
                class="text-[#f53003] dark:text-[#FF4433]  text-center">BETA</h1>
        </div>
    </main>
</div>
